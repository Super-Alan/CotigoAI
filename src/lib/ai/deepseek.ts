...
/**
 * Deepseek AI服务实现
 * 参考API文档: https://bailian.console.aliyun.com/#/api/?type=model&url=2868565
 */
export class DeepseekService implements IAIService {
  private apiKey: string;
  private apiUrl: string;
  private defaultModel = 'deepseek-v3.1';
  ...
  constructor() {
    ...
    if (!this.apiKey) {
      throw new AIServiceError('CONFIG_ERROR', 'DEEPSEEK_API_KEY未配置');
    }
  }
